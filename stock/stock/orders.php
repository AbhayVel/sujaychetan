	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    <label for="clientName" class="col-sm-3 control-label">Client Name And Bike Number</label>
			    <div class="col-sm-9">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group" >
				    <label for="vat" class="col-sm-3 control-label">Labour Charges </label>
				    <div class="col-sm-9">
				      <input type="Number" class="form-control" id="vat" name="vat" min="0" onchange="subAmount()" onkeyup="subAmount()"/>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="Number" class="form-control" id="discount" min="0" name="discount" onchange="discountFunc()" onkeyup="discountFunc()" autocomplete="off" />
				    </div>
				  </div> <!--/form-group-->	
				  <div class="form-group">
			  ...
			  <div class="col-md-6">
			  	<div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="Number" class="form-control" id="paid" min="0"  name="paid" autocomplete="off" onchange="paidAmount()"  onkeyup="paidAmount()" />
				    </div>
				  </div> <!--/form-group-->			  
				  <div class="form-group">
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group" >
				    <label for="vat" class="col-sm-3 control-label">Labour Charges</label>
				    <div class="col-sm-9">
				      <input type="Number" class="form-control" id="vat" name="vat"  min="0" onchange="subAmount()" onkeyup="subAmount()" value="<?php echo $data[5] ?>"  />
				  ...
				  <div class="form-group">
				    <label for="discount" class="col-sm-3 control-label">Discount</label>
				    <div class="col-sm-9">
				      <input type="Number" class="form-control" id="discount" min="0" name="discount" onchange="discountFunc()" onkeyup="discountFunc()" autocomplete="off" value="<?php echo $data[7] ?>" />
				    </div>
				  </div> <!--/form-group-->	
				  <div class="form-group">
				    <label for="grandTotal" class="col-sm-3 control-label">Grand Total</label>
			  ...
			  <div class="col-md-6">
			  	<div class="form-group">
				    <label for="paid" class="col-sm-3 control-label">Paid Amount</label>
				    <div class="col-sm-9">
				      <input type="Number" class="form-control" id="paid" name="paid" min="0" autocomplete="off" onchange="paidAmount()"  onkeyup="paidAmount()" value="<?php echo $data[9] ?>"  />
				    </div>
				  </div> <!--/form-group-->			  
				  <div class="form-group">
				    <label for="due" class="col-sm-3 control-label">Due Amount</label>
